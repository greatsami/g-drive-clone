    ...
    <AuthenticatedLayout>
        ...
        <div class="flex-1 overflow-auto">
            <table class="min-w-full">
                <thead class="ml-3 bg-gray-100 border-b">
                <tr>
                ...
                <tr v-for="file of allFiles.data" :key="file.id"
                    ...
                    <td class="px-6 py-4 max-w-[40px] text-yellow-500">
                        <div @click.stop.prevent="AddRemoveFavourite(file)">
                            <svg v-if="file.is_favourite" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
            ...
            <div v-if="!allFiles.data.length" class="py-8 text-center text-sm text-gray-500">
...
function loadMore() {
    ...
    if (allFiles.value.next === null || allFiles.value.next === undefined) {
        return
    }
